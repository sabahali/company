...
const Hero = () => {
  ...
  return (
    <>
      <Container className="flex flex-wrap items-center justify-center w-full h-[90vh]">
        ...
        <div className="flex flex-col flex-wrap justify-center items-center xs:w-[60vw] sm:w-[70vw] h-full w-full lg:w-1/2 md:w-2/3">
          <motion.div
