...
const item = {
  hidden: { opacity: 0 },
  show: { opacity: 1 ,duration:0.5,delay:1}
}
const Hero = () => {
  const sub = 'Sub Heading Sub Heading Sub Heading Sub Heading Sub Heading Sub Heading Sub Heading';
  const subbarray = sub.split(' ')
  return (
    <>
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <motion.h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white"
              initial={{ opacity: 0, }}
            ...
            <div className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              ...
              >
                ...
                {subbarray.map((item,index)=>(
                  <motion.li variants={item} key={index} size={50} className="inline-block">{item}&nbsp;</motion.li>
                ))}
              </motion.ul>
            </div>
